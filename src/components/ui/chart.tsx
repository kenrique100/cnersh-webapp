...
// Fully decoupled from conflicting Recharts v3 Tooltip constraints
        ...
        <div className="grid gap-1.5">
          {payload
              ...
              .map((item, index) => {
                ...
                const itemConfig = getPayloadConfigFromPayload(config, item, key)
                const itemPayload = item.payload as Record<string, any> | undefined
...
// Explicitly safe definitions mapping for Legend payload structures in v3
