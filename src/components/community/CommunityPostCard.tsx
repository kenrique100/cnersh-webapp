        ...
        >
            ...
            >
                ...
                <div
                    ...
                    className={`relative w-full ${bubbleClasses} px-3 py-2 shadow-sm cursor-pointer`}
                >
                ...
                {reply.children && reply.children.length > 0 && (
                    <div className={`mt-2 space-y-2 w-full ${isCurrentUser ? "pr-2" : "pl-2"}`}>
                ...
                <div
                    className={`absolute -top-3 ${isCurrentUser ? "left-0" : "right-0"} flex bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded shadow-lg transition-opacity z-10 ${
                ...
                >
                    {onReactToReply && (
                        <Popover>
                            ...
                            <PopoverContent className="w-auto p-2" align={isCurrentUser ? "start" : "end"} side="top">
