...
const typeConfig: Record<string, { icon: React.ElementType; color: string; bg: string; label: string }> = {
    ...
    PROJECT_STATUS: { icon: FolderIcon, color: "text-purple-600", bg: "bg-purple-100 dark:bg-purple-900", label: "Protocol Status" },
    REVIEW_ASSIGNED: { icon: UserCheckIcon, color: "text-indigo-600", bg: "bg-indigo-100 dark:bg-indigo-900", label: "Review Assigned" },
    REVIEW_REASSIGNED: { icon: UserCheckIcon, color: "text-amber-600", bg: "bg-amber-100 dark:bg-amber-900", label: "Review Reassigned" },
