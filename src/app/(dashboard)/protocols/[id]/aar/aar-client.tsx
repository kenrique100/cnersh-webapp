...
export default function AARClient({ projectId, projectTitle, application }: AARClientProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.success(
          "AAR application submitted. Please also send by email to the DROS office and submit physical hard copies to MINSANTE.",
          { duration: 8000 }
      );
      router.refresh();
    } catch (error) {
        ...
        <div className="container mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Protocol: <span className="font-medium">{safeTitle(projectTitle)}</span>
            </p>
              ...
              <div className="flex items-start gap-2 text-sm text-blue-700 dark:text-blue-400">
                ...
                <div className="space-y-1">
                  ...
                  <ol className="list-decimal list-inside space-y-0.5 ml-2 text-xs">
                    <li>
                      Email your AAR documents to <strong>{AAR_REQUIREMENTS.email}</strong>
                    </li>
